...
# %% auto 0
__all__ = ['counts_file', 'file_path', 'counts', 'log2fc_df', 'left', 'right', 'patterns', 'core_fixed_motifs_df',
           'flexible_motifs_df', 'get_sites_in_seq', 'score', 'identify_depleted_motifs_scanning_ends',
           'filter_to_core_motifs', 'get_fold_change_values_per_site', 'filter_sequences_without_core_motifs',
           'get_sites_scores', 'filter_redundant_patterns', 'update_motif_scores_from_unique_hits',
           'find_restricted_motifs', 'process_single_flexible_pattern', 'find_restricted_motifs_mp']
...
counts_file="counts_long_clean.csv"
file_path=os.path.join(data_path,counts_file)
counts=pd.read_csv(file_path, index_col=0)
counts = counts.replace(np.nan,0)
log2fc_df = calculate_log2fc(counts, reference_column='Control', count_threshold=20, pseudocount=1)
left, right = "GTCTAGGGCGGCGGTAAAAC", "ACTAGAGCACCAGAAGTCTA"
patterns = get_patterns() #[(6, 0, 0), (7, 0, 0), (3, 4, 4), (4, 1, 4), (4, 2, 4), (4, 3, 4), (4, 4, 4), (4, 5, 4), (4,6,4), (4,7,4), (4,8,4)]
core_fixed_motifs_df, flexible_motifs_df = find_restricted_motifs(log2fc_df["16226_R1"], 
                        left,
                        right, 
                        fixed_motif_scan_depth_k=6,
                        fixed_motif_max_length=4,
                        ...
                        flexible_motif_patterns=patterns,
                        flexible_motif_log2fc_thr=-1,
                        flexible_motif_min_support=3,
                        flexible_motif_score_thr=0.7
                        )
