...
__all__ = ['get_sites_in_seq', 'score', 'identify_depleted_motifs_scanning_ends', 'filter_to_core_motifs',
           ...
           'filter_redundant_iupac_patterns', 'update_motif_scores_from_unique_hits', 'find_restricted_motifs']
...
def filter_redundant_iupac_patterns(df, score_margin=0.05):
    """
    Filters a DataFrame of IUPAC patterns, removing redundant motifs based on
    ...
    1. p1 is a specific version of p2 (i.e., every sequence generated by p1
       is contained within a sequence generated by p2).
    ...
    for i, p1 in df_reset.iterrows():
        ...
        for j, p2 in df_reset.iterrows():
            ...
            is_subset = check_specific_matches_broad_iupac(motif1, motif2)

            if not is_subset:
                continue

            # motif1 is a subset of motif2. Now check if it should be dropped.
            is_superset = check_specific_matches_broad_iupac(motif2, motif1)
...
def find_restricted_motifs(log2fc_series, 
    ...
    if not all_flexible_motifs_data_list:
        ...
        flexible_motifs_results_df = filter_redundant_iupac_patterns( 
